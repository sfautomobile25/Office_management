...
export const accountsAPI = {
  ...
  createTransaction: (transactionData) =>
    API.post("/accounts/transactions", transactionData),

  // Journal Entries
  createJournalEntry: (entryData) =>
    API.post("/accounts/journal-entries", entryData),
  ...
  grantPermission: (permissionData) =>
    API.post("/accounts/permissions", permissionData),
  ...
  downloadPnL: (params) =>
    API.get("/accounts/reports/pnl/export", { params, responseType: "blob" }),

  getBalanceSheet: (params) =>
    API.get("/accounts/reports/balance-sheet", { params }),
  downloadBalanceSheet: (params) =>
    API.get("/accounts/reports/balance-sheet/export", {
      params,
      responseType: "blob",
    }),
};
...
export const cashManagementAPI = {
  ...
  getCashTransactions: (params) =>
    API.get("/cash/cash-transactions", { params }),
  ...
  generateDailySummary: (data) =>
    API.post("/cash/generate-daily-summary", data),
...
export const cashApprovalAPI = {
  ...
  getMonthlyByStatus: (status, month) =>
    API.get(
      `/cash/transactions?status=${encodeURIComponent(
        status
      )}&month=${encodeURIComponent(month)}`
    ),
  getPendingCount: () => API.get("/cash/pending-count"),
};
